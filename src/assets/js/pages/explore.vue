<template>
    <details class="explore-filter">
        <summary>
            ...
            <span class="explore-filter_details-open">Hide filters</span>
        </summary>
        ...
        <div class="checkbox-grid">
            <span v-for="countryCount in countryCounts" :key="`country-checkbox_${countryCount.name}`">
                <input
                    ...
                    class="explore-filter-checkbox"
                />
                <label :for="`country-checkbox_${countryCount.name}`" class="explore-filter-label">
    ...
    <div ref="scrollTarget" class="explore_result-summary">
        ...
        <span class="smaller" v-else
            >Showing <span class="larger">{{ firstShown }}-{{ lastShown }}</span> of
            <span class="larger">{{ filteredImages.length }}</span> matching images</span
        >
    </div>
...
function updateColumns() {
    numColumns.value = Math.floor(
        (masonryLayoutContainer.value.clientWidth + masonryGap.value) / (columnWidth + masonryGap.value),
    );
